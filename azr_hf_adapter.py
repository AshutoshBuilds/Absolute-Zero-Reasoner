...
from hf_generation_utils import generate_text_with_model

logger = logging.getLogger(__name__)

class HuggingFaceAdapter:
    def __init__(self, model_name: str, device: str = None, auth_token: str = None, use_separate_value_model: bool = True, hf_cache_dir: Optional[str] = None, logit_clamping_value: Optional[float] = 30.0, load_in_4bit: bool = False):
        """
        ...
        try:
            ...
            if is_checkpoint_dir:
                ...
                self.tokenizer, self.actor_model, self.critic_model, self.model = initialize_models_and_tokenizer(
                    ...
                    # Assuming float32 for now, can be parameterized if needed
                    torch_dtype_for_actor_critic=torch.float32,
    ...
    def generate(
        ...
        **kwargs: Dict[str, Any]  # Use Dict[str, Any] for kwargs typing
